...
using TripBooker.PaymentService.Model.Events.Reservation;
using TripBooker.PaymentService.Repositories;

namespace TripBooker.PaymentService.Services;

internal interface IPaymentService
{
    Task<PaymentModel> AddNewPayment(NewHotelReservation newReservationContract, CancellationToken cancellationToken);
